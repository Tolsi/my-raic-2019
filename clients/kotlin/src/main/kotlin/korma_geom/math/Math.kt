...
fun almostZero(a: Float) = abs(a) <= WorldSimulation.EPS

fun almostEquals(a: Double, b: Double) = almostZero(a - b)
fun almostZero(a: Double) = abs(a) <= WorldSimulation.EPS
...
// todo wtf?!
//fun isEquivalent(a: Double, b: Double, epsilon: Double = WorldSimulation.EPS): Boolean = (a - epsilon < b) && (a + epsilon > b)
fun Double.isEquivalent(b: Double, epsilon: Double = WorldSimulation.EPS): Boolean = (this - epsilon < b) && (this + epsilon > b)
...
fun Double.isAlmostZero(): Boolean = kotlin.math.abs(this) <= WorldSimulation.EPS
fun Double.isNanOrInfinite() = this.isNaN() || this.isInfinite()

fun Float.isAlmostZero(): Boolean = kotlin.math.abs(this) <= WorldSimulation.EPS
